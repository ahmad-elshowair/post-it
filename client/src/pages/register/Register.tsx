    ...
    <section className="vh-100 py-5">
      <div className="container d-flex flex-lg-row flex-column gap-5 justify-content-center align-items-center h-100">
        <header className="register-page__header d-flex align-items-center justify-content-center flex-column gap-4">
          <img src={`${config.api_url}/images/post_it.png`} className="w-75" alt="logo" />
          ...
          <div className="register-page__form__body d-flex flex-column gap-4">
            <div className="row g-3">
              <div className="col-md-6">
                <label className="form-label mb-1 text-success fw-medium" htmlFor="first_name">
                  First Name
                </label>
                <input
              ...
              <div className="col-md-6">
                <label className="form-label mb-1 text-success fw-medium" htmlFor="last_name">
                  Last Name
                </label>
                <input
                  className="form-control"
              ...
              <div className="col-md-6">
                <label className="form-label mb-1 text-success fw-medium" htmlFor="email">
                  Email
                </label>
                <input
                  className="form-control"
              ...
              <div className="col-md-6">
                <label className="form-label mb-1 text-success fw-medium" htmlFor="user_name">
                  User Name
                </label>
                <input
                  className="form-control"
                  ...
                  {...register('user_name', {
                    ...
                    validate: {
                      ...
                      startWitLetterOrNumber: (value: string) =>
                        (value && /^[a-z]/.test(value)) || 'USERNAME MUST START WITH A LETTER',
                    },
                  })}
                />
                {errors.user_name && (
              ...
              <div className="col-md-6">
                <label className="form-label mb-1 text-success fw-medium" htmlFor="password">
                  Password
                </label>
          ...
          {backendErrors && backendErrors.length > 0 && (
            <article className="w-100 text-center">
              {backendErrors.map((error, index) => (
                <p key={index} className="alert alert-warning mt-3 p-2 text-danger">
                  {error}
                </p>
              ))}
            </article>
